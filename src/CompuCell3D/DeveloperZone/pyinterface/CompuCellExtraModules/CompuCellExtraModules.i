...
%template (CustomCellAttributeSteppableDataAccessorTemplate) BasicClassAccessor<CustomCellAttributeSteppableData>; //necessary to get CustomCellAttributeSteppableData accessor working in Python

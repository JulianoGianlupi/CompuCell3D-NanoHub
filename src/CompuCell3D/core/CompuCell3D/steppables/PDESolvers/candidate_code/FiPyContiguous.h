	...
	*/
	...
	public:
		FiPyContiguous():Steppable(),concentrationFieldVector(0),maxNeighborIndex(0),boundaryStrategy(0){
			using namespace std;
			cerr<<"Default constructor FiPyContiguous"<<endl;
		...
		std::vector<Array3DFiPy<precision> * > getConcentrationFieldVector(){ return concentrationFieldVector;}
	...
	protected:
		...
		std::vector<Array3DFiPy<precision> * > concentrationFieldVector;
